...
**自动化工作流程：**
```
1. 用户指定：图片用什么模型 + 视频用什么模型
2. 从 WORKFLOW_KNOWLEDGE.md 读取对应公式
3. 按公式编写提示词（动作链：先→随后→最后）
4. 检查时长、对白数是否符合版本要求
```
...
| **WORKFLOW_KNOWLEDGE.md v3.0** | 完整知识库（15个部分） | 自动化核心参考 |
| **PROMPT_GUIDE.md** | 按模型区分的公式 | 写提示词时查阅 |
| **WORKFLOW_DEEP_REPORT.md** | 工作流分析报告 | 技术趋势参考 |
